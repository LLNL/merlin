...
!!! warning "Important Note"
    ...
    Before trying this, make sure you've properly set up your Merlin config file `app.yaml`. If you can run `merlin info` and see no errors you should be good to go. Otherwise, see either the [Configuring Merlin](./2_installation.md#configuring-and-connecting-to-a-redis-server) section of the installation step in the Tutorial or the [Configuration](../user_guide/configuration/index.md) page for more information.
