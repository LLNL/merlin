...
class BaseDetailedStatusTest(unittest.TestCase):
    ...
    # If we don't set this to False here then unittest will treat this class as a test case
    __test__ = False
...
class TestFilterApplication(BaseDetailedStatusTest):
    ...
    def test_apply_max_tasks(self):
        ...
        requested_statuses_diff = DeepDiff(
            status_test_variables.REQUESTED_STATUSES_WITH_MAX_TASKS,
            self.detailed_status_obj.requested_statuses,
            ignore_order=True,
        )
