...
# TODO for the most part the classes themselves aren't examined, these more resemble integration tests.
...
class TestMerlinStudy(unittest.TestCase):
    ...
    def test_no_env(self):
        ...
        try:
            study_no_env: MerlinStudy = MerlinStudy(
                merlin_spec_no_env_filepath
            )
