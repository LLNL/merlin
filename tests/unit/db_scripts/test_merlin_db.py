...
@pytest.fixture
def mock_merlin_db(mock_backend: MagicMock, mock_entity_managers: FixtureDict[str, MagicMock]) -> Generator[MerlinDatabase, None, None]:
    """
    ...
    """
    with patch("merlin.db_scripts.merlin_db.backend_factory") as mock_factory, \
...
class TestMerlinDatabase:
    ...
    def test_get_everything(self, mock_merlin_db: MerlinDatabase, mock_entity_managers: FixtureDict[str, MagicMock]):
        ...
        assert result == [
            ...
            "run1", "run2", "run3", 
            "logical_worker1", 
            "physical_worker1", "physical_worker2"
        ]
    
    def test_delete_everything_confirmed(self, caplog: CaptureFixture, mock_merlin_db: MerlinDatabase, mock_backend: MagicMock):
        """
    ...
    def test_delete_everything_cancelled(self, caplog: CaptureFixture, mock_merlin_db: MerlinDatabase, mock_backend: MagicMock):
        """
