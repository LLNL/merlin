...
## [Unreleased]
### Added
- The new 'multi' merlin resource keyword is available to start multiple celery workers on a node. Setting this variable to True will start the celery workers as daemons.
